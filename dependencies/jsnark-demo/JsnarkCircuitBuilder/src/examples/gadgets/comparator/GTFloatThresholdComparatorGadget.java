...
public class GTFloatThresholdComparatorGadget extends Gadget {
    ...
    public GTFloatThresholdComparatorGadget(Wire[] floatStringWires, int floatStringLen, int dotPosition,
    ...
    protected void buildCircuit() {
        ...
        compareResult = scaledFloat.isGreaterThanOrEqual(thresholdWire[0], compareMaxBitLength);
