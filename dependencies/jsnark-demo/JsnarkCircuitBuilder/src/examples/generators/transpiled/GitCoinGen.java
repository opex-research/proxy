...
public class GitCoinGen extends CircuitGenerator {
    private Wire[] HS;
    ...
    public GitCoinGen(String circuitName) {
	super(circuitName);
    }
...
//        String ciphertextStr = "e299486297f0c3a99796fbae87eb1cda0d867b9ed7eff0505fb2cb9dd915954f1a0a325a6b334aa9b44c05e430bb51e0470a8a0e9370e7d81319ee488f6b8108";
	...
	GitCoinGen generator = new GitCoinGen("GitCoinGen_Circuit");
	if (args.length == 0) {
//            // BTC example
//            generator.blockNr = 3;
...
//            // IBM example
	    ...
	    generator.threshold = new BigInteger("1406000"); // new BigInteger("1406000"); // scaled 10x
